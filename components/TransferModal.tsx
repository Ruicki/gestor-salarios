            ...
            <div className="bg-white dark:bg-zinc-900 w-full max-w-md rounded-3xl shadow-2xl overflow-hidden flex flex-col">
                    ...
                    <div className="pt-2">
                        ...
                        {sourceAccount && amount && parseFloat(amount) > sourceAccount.balance && (
                            <p className="text-red-500 text-sm font-bold mt-2 flex items-center gap-1">
                                ⚠️ Fondos insuficientes (Disp: ${sourceAccount.balance.toFixed(2)})
                            </p>
                        )}
                    </div>
                ...
                <div className="p-6 pt-2">
                    <button
                        ...
                        disabled={loading || !sourceId || !destinationId || !amount || (sourceAccount ? parseFloat(amount) > sourceAccount.balance : false)}
